...
echo '<table border="1" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#0000CC" class="table">';
	echo '<tr class="header"><th>File no</th><th>Title&nbsp;</th><th>Firstnames</th><th>Surname &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:Clickheretoprint()" onClick="window.print()"><img title="print" src="images/Print.png" alt="print" width="30" height="15" /></a></th></tr>';
...
echo '<div align="center"><b> Client Activity Sheet</b></div> <table border="1" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#0000CC" class="table">';
