                                ...
                                <div class="present">
                                    <form method="post" action="delete_msg.php">
                                        ...
                                        <table  width="100%"  border="0">
                                            <tr>
                                                <td height="47" colspan="3"><div class='cssmenu'> <ul><li><input type="submit" name="del_mult" id="search-submit"  value="delete" class="login"/></li><li><a href="admin_index.php?m=compose" alt="Write new message"> Compose</a></li><li><a href="admin_index.php?m=sent_msg" alt="Sent messages"> Sent</a></li><li><a href="admin_index.php?m=msg" onClick="loadPage( 'msg', 'msg.php');" >refresh</a></li></ul></div><br /></td>
                                            </tr> 
                                            <tr >
...
while ($row = mysql_fetch_array($Query)) {
    if ($row['status'] == 0 || $row['status'] == 3) {
        ?>     
                                                    <tr>
                                                        ...
                                                        <td class="tad">
        <?php echo strip_tags(substr($row['subject'], 0, 10)); ?><a style="color: #0000FF;" href="admin_index.php?m=read&id=<?php echo $row['msg_id']; ?>" onClick="loadPage( 'read', 'read_message.php');">...read more</a>
                                                        </td>
    ...
    <?php } elseif ($row['status'] == 1 || $row['status'] == 3) { ?>
                                                    <tr bgcolor="#D8D8D8">
                                                        ...
                                                        <td class="tad">
                                                            <b><?php echo strip_tags(substr($row['subject'], 0, 35)); ?><a style="color: #0000FF;" href="admin_index.php?m=read&id=<?php echo $row['msg_id']; ?>" onClick="loadPage( 'read', 'read_message.php');">...read more</a></b>
                                                        </td class="tad">
