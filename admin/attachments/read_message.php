...
<p>
 ...
 <div class="present">
  <div align="left">
  <b><a href="admin_index.php?m=reply&id=<?php echo $row['msg_id'];?>" id="search-submit" onClick="loadPage( 'reply', 'reply.php');" ><b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;"> &nbsp;&nbsp; Reply&nbsp;&nbsp;  </b> </a>&nbsp;&nbsp;
