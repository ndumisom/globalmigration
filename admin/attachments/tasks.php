...
<table cellpadding="3" cellspacing="3" border="0">
      <tr>
        <td height="47" colspan="3"><a href="admin_index.php?m=show_task" onClick="loadPage( 'show_task', 'include_files.php' );"><b style="background-color: #0066FF; color: white; border:1px solid white;">refresh</a></td>
      </tr> 
      <tr>
 ...
 <?php $t = 0; while( $row = mysql_fetch_array( $Query ) ) { 
  ...
  ?>     
      <tr>
          ...
          <td>
           <?php echo strip_tags( substr($row['allocated_task'],0,35));?><a href="admin_index.php?m=view&id=<?php echo $row['task_all_id'];?>" onClick="loadPage( 'view', 'include_files.php', '<?php echo $row['task_all_id'];?>' );">...read more</a>
          </td>
  ...
  <?php    } else { ?>
      <tr bgcolor="#D8D8D8">
          ...
          <td>
           <b><?php echo strip_tags( substr($row['allocated_task'],0,35));?><a href="admin_index.php?m=view&id=<?php echo $row['task_all_id'];?>" onClick="loadPage( 'view', 'include_files.php', '<?php echo $row['task_all_id'];?>' );">...read more</a></b>
          </td>
