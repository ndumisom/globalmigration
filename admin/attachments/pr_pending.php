...
echo '<a class="button4" href="admin_index.php?m=pr_pending" id="active"> PR Pending</a>&nbsp;&nbsp; <a class="button4" href="admin_index.php?m=trp_pending"> TRP Pending</a>';
...
$link = "admin_index.php?m=updates"; // Page name
