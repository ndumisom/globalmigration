<table class="tab" width="100%" cellspacing="0" cellpadding="0" border="0" bordercolor="#0000FF">
    <tr><td>
            ...
            <p>&nbsp;</p>
    <center>
        <a href="admin_index.php?m=reports" style="color: #0000FF; text-decoration: underline; font: Helvetica, Arial, sans-serif;"> <b>Normal Report</b></a></a><br/>
            <form action="admin_index.php?m=view_ministerial_report" method="post">
