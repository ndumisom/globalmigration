...
<table width="100%" cellspacing="0" cellpadding="0" border="1" bordercolor="#0000FF">
    ...
    <tr><td>
            ...
            if (isset($_POST['submit'])) {
                if (preg_match("/^[  a-zA-Z]+/", $_POST['name'])) {
                    ...
                    echo "<a href=' http://localhost/globalmigration/admin/admin_index.php'>back</a>";
    ...
    <tr><td>
            ...
            <form name="task" action="add_task.php" method="post" class="uniForm" onsubmit="return validateTask()">
                <h3>Task Allocation </h3><input type="button" onclick="window.location.href='http://localhost/globalmigration/admin/admin_index.php?m=sent_task'" value=" Sent " class="login"/> 
