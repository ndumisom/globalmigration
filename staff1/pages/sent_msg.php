                                        ...
                                        <table cellpadding="2" cellspacing="2" border="0">
                                            <tr>
                                                <td height="47" colspan="3"><div class='cssmenu'>
                                                        <ul>
                                                            <li><input type="submit" name="del_mult" id="search-submit"  value="delete" class="login"/></li><li> <a href="index.php?page=compose" alt="Write new message">Compose</a></li><li> <a href="index.php?page=msg"  alt> Inbox </a></li></ul></div><br /></td>
                                            </tr> 
                                            <tr>
