...
require_once("../classes/profile1.php");
$db=new profile();

 $row=$db->view_profile("6") 
...
<td>
<div class="post">
<h2 class="title"><a href="#">Information About <? echo $row['firstname'] ?></a></h2>
<div class="entry">
<p>
<p>
...
<p> 
 ...
 <table cellspacing="1" cellpadding="1">
  ...
  <tr>
      <td height="31" style="text-decoration:underline"><div style="text-decoration:underline"><a href="admin_index.php?m=change_p">Change password </a></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="31"></td>
