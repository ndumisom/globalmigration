...
<form method="post" action="p_compose.php" name="compose" onSubmit="return send_message( this );">
 ...
 <table width="100%" >
     <tr>
         <td height="47" colspan="3"><div class='cssmenu'> <ul><li><a href="index.php?m=msg" alt="Inbox"> Inbox </a></li><li><a href="index.php?m=sent_msg" alt="Sent messages"> Sent </a></li></ul></div><br /></td>
     </tr>
     <tr>
